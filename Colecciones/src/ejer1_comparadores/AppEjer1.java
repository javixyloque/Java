...
//		System.out.println("Socio 6:"+s4.toString());
		...
		Socio soc1=new Socio(10,"Carmen","10-02-1998");
		Socio soc2=new Socio(10,"Alberto","22-05-2010");
		ComparaNombres c3=new ComparaNombres();
		System.out.println(c3.compare(soc1,soc2));
		ComparaEdades c4=new ComparaEdades();
		System.out.println(c4.compare(soc1,soc2));		
